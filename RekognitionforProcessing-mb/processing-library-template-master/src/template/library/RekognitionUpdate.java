...
public class RekognitionUpdate {
	...
	public JSONObject Emotion;	
	public float Beauty;
	public JSONObject Race;
	...
	public RekognitionUpdate() {
	}

	public RekognitionUpdate(int w, int h) {
		photoWidth = w;
		photoHeight = h;
	}
	...
	/////////////MARK ADD///////////////////////
	 public void setEmotion(JSONObject emotionJSON) {
		 Emotion=emotionJSON;
	 }	
	 
	 public void setBeauty(double beautyJSON) {
		 Beauty=(float) beautyJSON;
	 }	

	 public void setRace(JSONObject raceJSON) {
		 Race=raceJSON;
	 }	
	...
	public void fromJSON(JSONObject json) {
		...
		/////////////MARK ADD///////////////////////
		setEmotion(json.getJSONObject("emotion"));
		setBeauty(json.getDouble("beauty"));
		setRace(json.getJSONObject("race"));
		///////////////////////////////////////////
